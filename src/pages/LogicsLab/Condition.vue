...
export default {
  ...
  methods: {
    ...
    data (n) {
      const array = [
        { name: this.condition.criterion[0].title, value: this.condition.alternative[n][1] },
        { name: this.condition.criterion[1].title, value: this.condition.alternative[n][2] },
        { name: this.condition.criterion[2].title, value: this.condition.alternative[n][3][0] },
        { name: this.condition.criterion[3].title, value: this.condition.alternative[n][4][0] }
      ]
      return array
    }
  }
