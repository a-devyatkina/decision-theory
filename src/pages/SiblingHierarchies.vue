  ...
  <div class="q-pa-md">
    ...
    <q-modal v-model="instruction" minimized ref="modalRef">
      <div style="padding: 50px">
        ...
        <p>
          1. При введении дробных значений в качестве разделителя используется "."<br>
          2. Допустимая погрешность для вектора глобальных приоритетов, индекса согласованности, отношения согласованности,
          среднего значения лямбда - 0.01. Для других полей погрешность - 0.03<br>
          3. Проценты необходимо вводить в виде дроби. Например 8%=0.08<br>
          4. В поле выбранной альтернативы необходимо ввести ее порядковый номер<br>
          5. Если в матрице производится корректировка, необходимо вводить значения,полученные после корректировки<br>
          6. Если что-то пошло не так и вы прервали процесс выполнения работы, продолжить можно будет с того шага, на котором вы остановились<br>
          7. Просмотреть данные на пройденных шагах можно нажав на название
        </p>
