<template lang="html">
  ...
  <table class="infotable" style = "margin:auto;padding: 5px">
    <tr class="infotr"><th class="infotd" style="background:#239A8E;color:white"><strong>Q1</strong><th class="infoth">a1</th><th class="infoth">a2</th><th class="infoth">a3</th></tr> <!--ряд с ячейками заголовков-->
    <tr class="infotr"><td class="infotd" style="background:#239A8E;color:white"><strong>a1</strong><td class="infotd" style = "text-align:center">1</td><td class="infotd">0</td><td class="infotd">0</td></tr>
    <tr class="infotr"><td class="infotd" style="background:#239A8E;color:white"><strong>a2</strong><td class="infotd" style = "text-align:center">0</td><td class="infotd">1</td><td class="infotd">0</td></tr>
    <tr class="infotr"><td class="infotd" style="background:#239A8E;color:white"><strong>a3</strong><td class="infotd" style = "text-align:center">0</td><td class="infotd">0</td><td class="infotd">1</td></tr>
  </table>
  <div v-if='!done'>
  <table class="infotable" style = "margin:auto">
    <tr class="infotr"> <th class="infoth">U<sub>Q1</sub>(a2,a1) - U<sub>Q1</sub>(a1,a2)</th><th class="infoth">U<sub>Q1</sub>(a3,a1) - U<sub>Q1</sub>(a1,a3)</th> <th>U<sub>Q1</sub>(a1) = 1 - sup()</th> </tr>
  ...
  <table style = "margin:auto;padding: 5px">
      <tr class="infotr"> <th class="infoth">U<sub>Q1</sub>(a1,a2) - U<sub>Q1</sub>(a2,a1)</th><th class="infoth">U<sub>Q1</sub>(a3,a2) - U<sub>Q1</sub>(a2,a3)</th> <th>U<sub>Q1</sub>(a2) = 1 - sup()</th> </tr>
  ...
  <table style = "margin:auto;padding: 5px">
      <tr class="infotr"> <th class="infoth">U<sub>Q1</sub>(a1,a3) - U<sub>Q1</sub>(a3,a1)</th><th class="infoth">U<sub>Q1</sub>(a2,a3) - U<sub>Q1</sub>(a3,a2)</th> <th>U<sub>Q1</sub>(a3) = 1 - sup()</th> </tr>
...
{{err}}
  ...
  <div v-else>
    <table class="infotable" style = "margin:auto">
      ...
      <tr class="infotr"><td class="infotd" style="text-align:center;">0</td><td class="infotd">0</td><td class="infotd">1</td></tr>
...
export default {
  ...
  methods: {
    onAnswer (message) {
      if (message[0] === '' || Number(message[0]) !== 0) {
      ...
      if (message[1] === '' || Number(message[1]) !== 0) {
        this.wrong[1] = false
      ...
      if (message[2] === '' || Number(message[2]) !== 0) {
        this.wrong[2] = false
      ...
      if (message[3] === '' || Number(message[3]) !== 0) {
        this.wrong[3] = false
      ...
      if (message[4] === '' || Number(message[4]) !== 0) {
        this.wrong[4] = false
      ...
      if (message[5] === '' || Number(message[5]) !== 0) {
        this.wrong[5] = false
      ...
      if (message[6] === '' || Number(message[6]) !== 1) {
        this.wrong[6] = false
      ...
      if (message[7] === '' || Number(message[7]) !== 1) {
        this.wrong[7] = false
      ...
      if (message[8] === '' || Number(message[8]) !== 1) {
        this.wrong[8] = false
      ...
      if (this.wrong[0] && this.wrong[1] && this.wrong[2] && this.wrong[3] && this.wrong[4] && this.wrong[5] && this.wrong[6] && this.wrong[7] && this.wrong[8]) {
        sessionStorage.setItem('arr5', JSON.stringify(this.message))
        this.$emit('success1')
      } else {
  ...
  mounted () {
    if (sessionStorage.getItem('arr5')) {
      this.message = JSON.parse(sessionStorage.getItem('arr5'))
    }
  },
  watch: {
    message (newmessage) {
