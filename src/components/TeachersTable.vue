<template>
  <dev>
    ...
    <q-table :data="content" :columns="columns" row-key="id" hide-bottom rows-per-page-options="0"
      :pagination.sync="pagination" :filter="filter" class="q-ma-md">
