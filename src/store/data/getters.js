...
export const getLab3 = (state) => (lid) => {
  return state.lab3[lid]
}
...
export const getWork3 = (state) => (wid) => {
  return state.work3[wid]
}

export const getStudentWorks3 = (state) => (sid) => {
  let works = {}
  for (let wid in state.work3) {
    if (state.work3[wid].student === sid) {
...
export const getCourseStudentWorks3 = (state) => (sid, cid) => {
  let works = {}
  for (let wid in state.work3) {
